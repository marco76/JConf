...
public class GitHubTextUtil {
    ...
    static String findStartingChar(String gitText) {
     ...
     */
    static String replaceImages(String result, String path) {
        return result.replace("{{site.baseurl}}", path);
    }

    public static String convertFromJekyllText(String gitText, String path){
        return replaceImages(findStartingChar(gitText), path);
    }
}
